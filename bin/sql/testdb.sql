...
-- Drop all tables form command line
-- grep CREATE bin/sql/money_pal.sql | sed -e 's|CREATE|DROP|' -e 's|(|;|'

-- Drop all tables with cascade
-- grep CREATE bin/sql/money_pal.sql | sed -e 's|CREATE|DROP|' -e 's|(| CASCADE;|'
